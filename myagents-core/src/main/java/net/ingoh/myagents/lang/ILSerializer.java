...
public class ILSerializer {
    ...
    public static <T> String serialize(T node) throws IOException {
        assert node != null : "Node cannot be null";
        return objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(node);
    }

    public static <T> void saveToFile(Path path, T node) throws IOException {
    ...
    public static <T> T deserialize(String content, Class<T> cls) throws IOException {
        assert content != null : "Content cannot be null";
        assert !content.isEmpty() : "Content cannot be empty";
    ...
    public static <T> T deserialize(JsonNode node, Class<T> cls) throws IOException {
        assert node != null : "Node cannot be null";
        assert cls != null : "Class cannot be null";
