...
import net.ingoh.myagents.lang.lexers.*;
...
public class DSLParser {
    public static ILNode parse(String content, Class<?> targetClass) {
        ...
        if (targetClass == Environment.class) {
            return parse(content, EnvironmentLexerImpl.class, EnvironmentParserImpl.class, EnvironmentVisitorImpl.class, EnvironmentParserImpl.ProgramContext.class);
        }
        if (targetClass == Agent.class) {
            return parse(content, AgentLexerImpl.class, AgentParserImpl.class, AgentVisitorImpl.class, AgentParserImpl.ProgramContext.class);
        }
        throw new RuntimeException("No parser found for target class: " + targetClass.getName());
    }

        @SuppressWarnings("unchecked")
        public static <L extends Lexer, P extends Parser, V extends AbstractParseTreeVisitor<Object>, C extends ParserRuleContext> ILNode parse(String content, Class<L> lexerClass, Class<P> parserClass, Class<V> visitorClass, Class<C> programContextClass) {
            assert content != null : "Content cannot be null";
