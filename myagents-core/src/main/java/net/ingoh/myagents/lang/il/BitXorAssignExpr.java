...
public record BitXorAssignExpr(
    ...
    public Object accept(Interpreter interpreter) {
        ...
        variableSymbol.setValue(interpreter, interpreter.getExecutionSource().getSource(), variableSymbol.getValue(interpreter, interpreter.getExecutionSource().getSource(), long.class) ^ ((Number) valueSymbol).longValue());
